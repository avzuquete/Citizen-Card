...
static const char * PTEID_errors[] = {
    "",
...
static const char * PTEID_OPENSC_errors_1100 [] = {
    "Reader error",
    "No readers found",
    "Slot not found",
...
static const char * PTEID_OPENSC_errors_1200 [] = {
    "Card command failed",
    "Card file not found",
...
static const char * PTEID_OPENSC_errors_1300 [] = {
...
static const char * PTEID_OPENSC_errors_1400 [] = {
...
static const char * PTEID_OPENSC_errors_1500 [] = {
    "PKCS #15 init",
...
static const char * PTEID_OPENSC_errors_1900 [] = {
    "Unknown error",
...
PTEID_errorString ( long code )
{
    if (code > 0)
        ...
        return PTEID_OPENSC_errors_1200[-code-1200];
    else
